...
def main(genomes, config):
    ...
    s = Snake((255, 0, 0), (random.randint(0, 10), 10))
    ...
    while running:
        ...
        #         genome.fitness -= 1.0
        #     print('Score: ', score)
        #     print('You Lost, cuz out of gamefield')
        #     s.reset((10, 10))
        #     running = False
        s.move()
        distance = calc_distance(snack.pos, s.body[0].pos)
        distance_list.append(distance)
        # output = nets[0].activate(float(s.body[0].pos), float(distance[0]), float(distance[1]))
        # print(output)
        if distance[0] < 0 and s.move_done != "right":
            s.move_right()
        elif distance[0] > 0 and s.move_done != "left":
            s.move_left()
        elif distance[1] > 0 and s.move_done != "up":
            s.move_up()
        elif distance[1] < 0 and s.move_done != "down":
            s.move_down()
    ...
    del s
    s = Snake((255, 0, 0), (random.randint(0, 10), 10))
    redraw_window(surface=window, score=score)
